...
url1 = 'http://demo.thingsboard.io:80/api/v1/VoQvFNMhjRTwwE0tjLFw/telemetry'
url2 = 'http://demo.thingsboard.io:80/api/v1/KOYTlaRA1OGYRUnPDHzw/telemetry'
url3 = 'http://demo.thingsboard.io:80/api/v1/ztM6NKNGogWz5hmiVU5V/telemetry'
